...
#background
b_image=pygame.image.load(r'E:\v_project\python\snake/Back.png')
...
#main screen image
a_image=pygame.image.load(r'E:\v_project\python\snake/anaconda.png')
a_x =220
a_y=-140
def ana(x,y):
...
def game_loop():
	...
	i=0
	brown=(210,105,30)
	pygame.mixer.music.load(r'E:\v_project\python\snake/bm1.mp3')
	pygame.mixer.music.play(-1)
	if(not os.path.exists('untitled.txt')):
		with open(r'E:\v_project\python\snake/untitled.txt','r') as f:
			hiscore=f.read()
	with open(r'E:\v_project\python\snake/untitled.txt','r') as f:
		hiscore=f.read()
	while not exit_game:
		#gameover
		if game_over1:
			with open(r'E:\v_project\python\snake/untitled.txt','w') as f:
				f.write(str(hiscore))
			win.fill((0,0,0))
			...
			if head in snk_list[:-1]:
				pygame.mixer.music.load(r'E:\v_project\python\snake/Glass_Break.mp3')
